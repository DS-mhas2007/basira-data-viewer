...
const BASE_URL = "https://basira-data-viewer.lovable.app";
    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/guide/arabic-csv-excel", changefreq: "monthly", priority: "0.8" },
          { path: "/guide/fix-arabic-encoding", changefreq: "monthly", priority: "0.8" },
